    ...
    <div className=' md:pt-16 sm:pt-10 pt-6'>
      <div className='flex md:flex-row sm:mb-14 mb-4 flex-col-reverse justify-between items-center xl:px-32 lg:px-12 md:px-10  xsm:px-5 px-3'>
        <div className='text flex-[.5]'>
          <h1 className="md:text-[31px] lg:text-[56px] sm:text-[47px] xsm:text-[30px]   text-[29px] md:pt-0 pt-5  text-[#434343] font-['red_rose'] font-normal">
          ...
          <p className='sm:text-2xl xsm:text-[17px] text-[16px] text-[#434343] pt-4'>
      ...
      <div className='sm:mt-12 mt-6 mb-14'>
        <h3 className=' font-[700] md:text-[40px] lg:text-5xl sm:text-[32px] xsm:text-[30px] text-[24px] text-center text-black'>
          Inspiration for your next adventure
        </h3>
        <div className='grid md:gap-6 xmd:gap-6 lg:gap-3  gap-6 xl:gap-8 sm:gap-6  xsm:gap-2 lg:grid-cols-4 lg:grid-rows-2 md:grid-cols-2 md:grid-rows-4 sm:grid-cols-2 sm:grid-rows-4 xsm:grid-cols-1 xsm:grid-rows-8 mt-12 xl:px-32 lg:px-12 md:px-24 sm:px-6 xsm:px-10 xmd:px-20  px-4'>
